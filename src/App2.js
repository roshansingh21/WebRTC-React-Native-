...
/* ==============================
 Global variables
 ================================ */
const url = new WebSocket('ws://localhost:8080');
  ...
  render() {
    ...
    return (
      <View style={container.style}>
        ...
        <RTCView mirror={true} streamURL={streamURL} style={rtcView.style}/>
        
        {
          mapHash(remoteList, (remote, index) => {
            return <RTCView mirror={true} key={index} streamURL={remote} style={rtcView.style}/>;
          })
        }
      </View>
    );
